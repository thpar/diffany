 ...
 * Additionally, a consensus edge can be generated by taking into account the edge type-to-category mapping.
 * 
...
public abstract class EdgeOntology
{
	...
	/**
	 * Retrieve an {@link EdgeDrawing} object which knows how to define the visual styles in an input (reference or condition-dependent) or consensus network
	 * 
	 * @return the EdgeDrawing object for the input and consensus network(s) (i.e. all but the differential networks)
	 */
