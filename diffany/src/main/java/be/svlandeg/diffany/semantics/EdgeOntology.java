...
public abstract class EdgeOntology
{
	...
	public EdgeDefinition getSharedEdge(EdgeDefinition refEdge, EdgeDefinition conEdge, double cutoff) throws IllegalArgumentException
	{
		...
		String parent = commonParent(conCat, refCat);
		if (parent != null)
		{
	 ...
	 */
	protected String commonParent(String childCat1, String childCat2)
	{
		if (! catHierarchy.containsKey(childCat1))
		{
			return null;
		}
		if (! catHierarchy.containsKey(childCat2))
		{
			return null;
		}
		if (catHierarchy.get(childCat1).equals(catHierarchy.get(childCat2)))
		{
			return catHierarchy.get(childCat1);
		}
		return null;
	}
